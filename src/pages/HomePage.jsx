...
function HomePage() {
  const textstyle = {
    background: `-webkit-linear-gradient(left, #5065DA, #556FFF, #C557AD, #E65F9A, #E66176, #FFFFFF)`,
  ...
  const svgStyle = {
    marginRight: '8px', // Adjust spacing between SVG and text
  };
  return (
    <div style={{overflowY:"auto",backgroundColor:"black"}}>
      <div className={style.main} >
        <div className={style.profile}>
          <h1 className="totalname" style={{ fontSize: "22px" }}>
            Hey <span style={textstyle}>Anirudh</span> <span>👋</span>
          </h1>
          <img src="profile.png" />
        </div>
        <p className={style.niceday} >It’s a nice day to learn something new</p>
      </div>
      <div className={style.main}>

      <div  style={containerStyle}>
        <div className={style.jointext}><p>Join and help us in building Airvoice!</p></div>
        <button className={style.combtn} style={buttonTextStyle}>
          <span>
            <svg
              width="12"
              height="12"
      ...
      <div className={style.randerview}>
        <Courses title={"Courses for you"} subtitle={"Listen to byte-sized audio courses from top thinkers"}/>
        <Courses title={"Article Reads"} subtitle={"Listen to audio versions of top web articles"}/>
        <Tweets/>
