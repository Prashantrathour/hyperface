...
function Detailpage() {
  ...
  return (
    <div style={{ backgroundColor: "#191B20",height:"100%",display:"flex",justifyContent:"center",flexDirection:"column"}}>
      <nav className={style.navbar}>
        ...
        >
          <g id="Frame" clip-path="url(#clip0_2_261)">
            <path
              id="Vector"
        ...
        >
          ...
          <g id="iPhone 11 Pro Max - 61">
            <rect
              width="414"
              height="896"
              transform="translate(-366 -64)"
              fill="#191B20"
            />
            <g id="navbar-plain">
      ...
      <div className={style.mainsection}>
        <div className={style.imagediv}>
          ...
          <div>
            <h6>Fundamentals of Product Des..</h6>
